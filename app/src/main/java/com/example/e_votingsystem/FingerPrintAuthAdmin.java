...
public class FingerPrintAuthAdmin extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_finger_print_auth_admin);
        ...
        BiometricPrompt biometricPrompt=new BiometricPrompt(FingerPrintAuthAdmin.this, executor, new BiometricPrompt.AuthenticationCallback() {
            @Override
            ...
            public void onAuthenticationSucceeded(@NonNull BiometricPrompt.AuthenticationResult result) {
                ...
                startActivity(new Intent(FingerPrintAuthAdmin.this, HomePageAdmin.class));
